        ...
        # 채팅 내용 뒤의 두 글자가 등록인 경우
            ...
            if '전' in user_msg.get(chat_id):
                ...
                if not busgo:
                    ...
                    cron = f'(crontab -l 2>/dev/null; echo "*/1 * * * * python3 /home/ubuntu/telegram_alarm/telegram-django/bus_alarm.py {chat_id} {minute[0]} go & sleep 30; python3 /home/ubuntu/telegram_alarm/telegram-django/bus_alarm.py {chat_id} {minute[0]} go") | sudo crontab -u {chat_id} -'
                    os.system(user)
                    os.system(cron)
